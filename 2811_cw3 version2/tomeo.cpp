...
vector<QIcon> geticon(string loc){
    ...
    while (it.hasNext()) {
        ...
        if(f.contains("play")||f.contains("pause")||f.contains("fast")||f.contains("back")||f.contains("sound")||f.contains("z_replay")||f.contains("z_zquan")) {
...
int main(int argc, char *argv[]) {
    ...
    button_qw->setGeometry(0,0,225,lists.size()*170);
    ...
    hx_wind->addWidget(top_wow,0,2,1,1);
